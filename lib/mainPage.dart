...
import 'package:healthlink/settingsPage.dart';
    ...
    return Scaffold(
        ...
        body: kIsWeb
            ? Stack(fit: StackFit.expand, children: [
                buildBackground(),
                Align(alignment: Alignment(-1, -1), child: buildGreet(context)),
                Align(
            ...
            : Stack(fit: StackFit.expand, children: [
                buildBackground(),
                Align(alignment: Alignment(0, -0.6), child: buildGreett()),
                Align(
